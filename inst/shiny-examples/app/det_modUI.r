            ...
            tabsetPanel(
              tabPanel("Disease",
                       sliderInput(ns("beta"), "transmission coefficient",
                                   value = 0.27, min = 0, max = 0.7, step = 0.01),
